...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      from: "DevMovers Contact <onboarding@resend.dev>",
    ...
    await resend.emails.send({
      from: "DevMovers <onboarding@resend.dev>",
      to: [email],
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #131313; color: #e5e2e1; padding: 32px; border-radius: 16px;">
          ...
          <div style="margin-top: 32px; text-align: center;">
            <a href="https://calendly.com" style="display: inline-block; background: #FFE224; color: #131313; font-weight: 700; padding: 14px 28px; border-radius: 999px; text-decoration: none; font-size: 14px;">
