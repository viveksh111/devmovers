...
function IconBadge({ type }: { type: "check" | "cross" | undefined }) {
  ...
  if (type === "check")
    return (
      <span className="inline-flex items-center justify-center w-5 h-5 rounded-full mr-2 text-xs font-black"
    ...
    <section id="comparison" className="py-32 px-6 bg-zinc-950 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(ellipse at 50% 0%, rgba(255,226,36,0.08) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
            ...
            <span style={{ color: "#FFE224" }}>founders</span>
          </h2>
          <p className="text-zinc-500 max-w-lg mx-auto">
            We built DevMovers to fix everything that's broken about hiring agencies and freelancers.
          </p>
        </motion.div>

        {/* Table */}
        <div className="w-full overflow-x-auto rounded-2xl border border-zinc-800/50">
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-zinc-800">
                ...
                {/* DevMovers header — highlighted */}
                <th className="py-5 px-6 text-left w-[23%]"
