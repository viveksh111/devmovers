          ...
          <div>
            ...
            <FadeIn direction="up" delay={0.2}>
              <p className="text-zinc-400 text-lg leading-relaxed mb-6">
                DevMovers is a team of passionate developers, engineers, and problem-solvers
                committed to building high-quality digital solutions.
              </p>
            </FadeIn>
            <FadeIn direction="up" delay={0.3}>
              <p className="text-zinc-400 leading-relaxed mb-6">
                We started as a freelancing team with a clear vision — to help startups and
                businesses launch their ideas quickly, securely, and efficiently. Our team combines
                expertise in full-stack development, DevOps, and security to deliver reliable and
                scalable solutions.
              </p>
            </FadeIn>
          </div>
            ...
            <StaggerChildren className="space-y-0" staggerDelay={0.15}>
              <StaggerItem>
                <div className="p-10 border border-outline-variant/10 bg-surface-container-low mb-0">
                  ...
                  <p className="text-white text-lg font-medium leading-relaxed">
                    To empower businesses by delivering secure, scalable, and high-performance
                    digital products.
                  </p>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div className="p-10 border border-outline-variant/10 bg-surface-container">
                  ...
                  <p className="text-white text-lg font-medium leading-relaxed">
                    To become a trusted global technology partner for startups and enterprises.
                  </p>
                </div>
              </StaggerItem>
              ...
              <StaggerItem>
                <div className="grid grid-cols-3 gap-0 mt-0">
                  {[
                    ...
                    >
                      <div className="text-3xl font-black mb-1" style={{ color: '#FFE224' }}>
                        {stat.value}
                      </div>
